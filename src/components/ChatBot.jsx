        ...
        <div className={` ${open ? "w-[390px]" : "w-[60px] flex items-center  justify-between"} shadow-cards py-3 transition-all duration-200 flex fixed right-0 top-0 h-screen   flex-col  bg-gray `}>
...

            {
                ...
                <>
                    <div
                        onClick={() => { setOpen(!open) }}
                        className=" w-full h-screen bg-gray/20 fixed z-10 right-0 top-0"></div>
                    <div className=" z-20 relative m-3 border-[3px] flex justify-between flex-col border-primary rounded-md flex-1  text-white">
